...
* **0. How Import a simple function from a simple file**
  * [0-add.py](./0-add.py): This is a Python program that imports the function
...
* **3. Infinite addition**
i  * [3-infinite_add.py](./3-infinite_add.py): Python program that prints the result of the
...
* **6. Build my own calculator!**
  * [100-my_calculator.py](./100-my_calculator.py): To write a Python program that imports all functions
...
* **7. Easy print**
  * [101-easy_print.py](./101-easy_print.py): This is a Python program that prints
...
* **9. Fast alphabet**
  * [103-fast_alphabet.py](./103-fast_alphabet.py): This is Python program that prints the alphabet in
