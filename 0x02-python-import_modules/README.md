...
3. Infinite addition i * 3-infinite_add.py: Python program that prints the result of the addition of all arguments.
...
100-my_calculator.py: To write a Python program that imports all functions from the file calculator_1.py and handles basic operations.
...
101-easy_print.py: This is a Python program that prints #pythoniscool followed by a new line in the standard output.
...
103-fast_alphabet.py: This is Python program that prints the alphabet in uppercase, followed by a new line.
